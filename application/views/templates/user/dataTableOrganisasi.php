        ...
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div class="text-uppercase">Data <?= $main['menu']; ?>
                    <div class="page-title-subheading">Organisasi Pengalamanku
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card mb-3 widget-content bg-midnight-bloom">
                        <div class="widget-content-wrapper text-white">
                            <div class="widget-content-left">
                                <div class="widget-heading">Tambah Organisasi</div>
                                <div class="widget-subheading">Organisasi</div>
                            </div>
                            <div class="widget-content-right">
                                <div class="widget-numbers text-white">
                                    <span>
                                        <a href="<?= base_url('user/organisasi/add') ?>" class="btn btn-info">Tambah</a>
                                    </span>
                                </div>
                            </div>
                        </div>
