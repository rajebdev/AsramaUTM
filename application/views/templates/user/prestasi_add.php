		...
		<div class="form-row">
			<div class="col-md-6">
				<div class="position-relative form-group">
					...
					<input name="nama_prestasi" id="nama_prestasi" type="text" class="form-control" autofocus>
					<?= form_error('nama_prestasi', '<small class="text-danger pl-3">', '</small>') ?>
				</div>
				<div class="position-relative form-group">
					<label for="tahun_prestasi" class="">Tahun Prestasi</label>
					<input name="tahun_prestasi" id="tahun_prestasi" type="text" class="form-control" autofocus>
