		...
		<div class="form-row">
			<div class="col-md-6">
				<div class="position-relative form-group">
					...
					<input name="nama_organisasi" id="nama_organisasi" type="text" class="form-control" value="<?= $table['nama_organisasi'] ?>" autofocus>
					<?= form_error('nama_organisasi', '<small class="text-danger pl-3">', '</small>') ?>
				</div>
				<div class="position-relative form-group">
					<label for="tahun_masuk" class="">Tahun Masuk</label>
					<input name="tahun_masuk" id="tahun_masuk" type="text" class="form-control" value="<?= $table['tahun_masuk'] ?>" autofocus>
					<?= form_error('tahun_masuk', '<small class="text-danger pl-3">', '</small>') ?>
				</div>
				<div class="position-relative form-group">
					<label for="tahun_selesai" class="">Tahun Selesai</label>
					<input name="tahun_selesai" id="tahun_selesai" type="text" class="form-control" value="<?= $table['tahun_selesai'] ?>" autofocus>
