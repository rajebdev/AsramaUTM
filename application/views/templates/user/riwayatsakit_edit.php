		...
		<div class="form-row">
			<div class="col-md-6">
				<div class="position-relative form-group">
					...
					<input name="nama_penyakit" id="nama_penyakit" type="text" class="form-control" value="<?= $table['nama_penyakit'] ?>" autofocus>
					<?= form_error('nama_penyakit', '<small class="text-danger pl-3">', '</small>') ?>
				</div>
				<div class="position-relative form-group">
					<label for="ket_penyakit" class="">Keterangan Tambahan</label>
					<textarea name="ket_penyakit" id="ket_penyakit" type="text" class="form-control"><?= $table['ket_penyakit'] ?></textarea>
