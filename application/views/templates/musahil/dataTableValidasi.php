                            ...
                            <tbody id="show_data">
                                ...
                                foreach ($table as $key => $row) : ?>
                                    <tr role="row" class="odd">
                                        ...
                                        <td><?= $row->nim ?></td>
                                        <td><?= $row->nama ?></td>
                                        <td><?= $row->validasi == 1 ? '<div class="mb-2 mr-2 badge badge-pill badge-success">Sudah Validasi</div>' : '<div class="mb-2 mr-2 badge badge-pill badge-danger">Belum Validasi</div>'; ?></td>
                                        <td class="text-center">
                                            <a href="<?= base_url(($level == 1337 ? 'Admin/' : 'musahil/') . 'validasi_berkas/view/' . base64_encode($row->nim)) ?>" class=" btn btn-primary text-white"><i class="fas fa-eye"></i></a>
