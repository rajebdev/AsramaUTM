																	...
																	<h4 class="timeline-title">Something not important
																		<div class="avatar-wrapper mt-2 avatar-wrapper-overlap">
																			<div class="avatar-icon-wrapper avatar-icon-sm">
																				<div class="avatar-icon"><img src="<?= base_url('assets/') ?>assets/images/avatars/1.jpg" alt=""></div>
																			</div>
																			<div class="avatar-icon-wrapper avatar-icon-sm">
																				<div class="avatar-icon"><img src="<?= base_url('assets/') ?>assets/images/avatars/2.jpg" alt=""></div>
																			</div>
																			<div class="avatar-icon-wrapper avatar-icon-sm">
																				<div class="avatar-icon"><img src="<?= base_url('assets/') ?>assets/images/avatars/3.jpg" alt=""></div>
																			</div>
																			<div class="avatar-icon-wrapper avatar-icon-sm">
																				<div class="avatar-icon"><img src="<?= base_url('assets/') ?>assets/images/avatars/4.jpg" alt=""></div>
																			</div>
																			<div class="avatar-icon-wrapper avatar-icon-sm">
																				<div class="avatar-icon"><img src="<?= base_url('assets/') ?>assets/images/avatars/5.jpg" alt=""></div>
																			</div>
																			<div class="avatar-icon-wrapper avatar-icon-sm">
																				<div class="avatar-icon"><img src="<?= base_url('assets/') ?>assets/images/avatars/9.jpg" alt=""></div>
																			</div>
																			<div class="avatar-icon-wrapper avatar-icon-sm">
																				<div class="avatar-icon"><img src="<?= base_url('assets/') ?>assets/images/avatars/7.jpg" alt=""></div>
																			</div>
																			<div class="avatar-icon-wrapper avatar-icon-sm">
																				<div class="avatar-icon"><img src="<?= base_url('assets/') ?>assets/images/avatars/8.jpg" alt=""></div>
																			</div>
														...
														<div><span class="vertical-timeline-element-icon bounce-in"><i class="badge badge-dot badge-dot-xl badge-danger">
															...
															<div class="vertical-timeline-element-content bounce-in">
																...
																<p>Lorem ipsum dolor sit amit,consectetur eiusmdd tempor
																	...
																	minim veniam quis nostrud</p><span class="vertical-timeline-element-date"></span>
															</div>
														</div>
													</div>
													<div class="vertical-timeline-item vertical-timeline-element">
							...
							<div class="widget-content p-0">
								<div class="widget-content-wrapper">
									...
									<div class="widget-content-left mr-3">
										<div class="widget-content-left"><img width="42" class="rounded" src="<?= base_url('assets/') ?>assets/images/avatars/1.jpg" alt="" />
										</div>
									</div>
									<div class="widget-content-left">
								...
								<div class="vertical-timeline-element-content bounce-in">
									<h4 class="timeline-title">Something not important
										<div class="avatar-wrapper mt-2 avatar-wrapper-overlap">
											...
											<div class="avatar-icon-wrapper avatar-icon-sm">
												<div class="avatar-icon"><img src="<?= base_url('assets/') ?>assets/images/avatars/6.jpg" alt=""></div>
											</div>
											<div class="avatar-icon-wrapper avatar-icon-sm">
												<div class="avatar-icon"><img src="<?= base_url('assets/') ?>assets/images/avatars/7.jpg" alt=""></div>
											</div>
			...
			<div class="modal-content">
				<form method="post" id="formToken">
					...
					<div class="modal-body">
						<div class="form-row">
							<div class="col-md-12">
								<div class="position-relative form-group"><input name="nim" id="nim" placeholder="NIM..." type="text" class="form-control"></div>
							</div>
							<div class="col-md-12">
								<div class="row">
									<div class="col-md-8">
	...
	<script>
		$(document).ready(function() {
			$("#tokensubmit").click(function() {
				var data = $('#formToken').serialize();
				$.ajax({
					type: 'POST',
					url: "<?= base_url(($level == 1337 ? 'admin' : 'musahil') . '/manage/token') ?>",
					data: data,
					success: function() {
						console.log("SUCCESS insert token");
					}
				});
			});
		});
