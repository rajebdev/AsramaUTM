								...
								<div class="widget-content-left">
									<div class="btn-group">
										<a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="p-0 btn">
											<?php if ($level != "null") { ?>
												<img width="42" height="40" class="rounded-circle" src="<?= base_url('uploaded/') ?>photoProfile/<?= $user['photo'] ?>" alt="">
											<?php } else { ?>
														...
														<div class="widget-content p-2 bg-light">
															<div class="widget-content-wrapper p-2 bg-light">
																...
																<div class="widget-content-right mr-2">
																	...
																	<?php } else { ?>
																		<a class="btn btn-success" href="<?= base_url("Asrama/login") ?>">Login
																		</a>
																	<?php } ?>
																</div>
															</div>
				...
				<div class="scrollbar-sidebar">
					<div class="app-sidebar__inner">
						<ul class="vertical-nav-menu">
							...
							<?php if ($level != "null") { ?>
								<li>
									<a href="<?= base_url($mylevel . "/") ?>" <?= $main['menu'] == 'Dashboard' ? 'class="mm-active"' : ''; ?>>
								...
								<li class="hyper" id="change_pwd">
									<a href="<?= base_url($mylevel . "/password") ?>">
								...
								<?php if ($level == 999 || $level == 1337) { ?>
									...
									<li class="hyper" id="get_token">
										<a href="<?= base_url($mylevel . '/manage_token/view') ?>" <?= $main['menu'] == 'Token' ? 'class="mm-active"' : ''; ?>">
											<i class="metismenu-icon pe-7s-ticket">
											</i>Get Token Daftar
										</a>
									</li>
									<li>
										<a href="<?= base_url($mylevel . '/validasi_berkas/view') ?>" <?= $main['menu'] == 'Validasi' ? 'class="mm-active"' : ''; ?>>
											<i class="metismenu-icon pe-7s-users">
											</i>Validasi Berkas
										</a>
									</li>
