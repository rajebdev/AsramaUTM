							...
							<table class="mb-0 table table-striped">
								...
								<tbody>
										...
										<td>
											<select class="form-control" name="jurusan">
												<?php foreach ($jur as $j) { ?>
													<option value="<?= $j->id_jurusan ?>" <?php if ($j->id_jurusan == $data['id_jurusan']) {
																								echo "selected";
									...
									<tr>
										...
										<td><a href="<?= base_url("$mylevel/password") ?>" class="btn btn-warning form-control">Reset Password</a></td>
									</tr>
								</tbody>
								</form>
							</table>
